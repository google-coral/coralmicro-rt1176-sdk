...
typedef enum 
{
    MPAF_STATUS_SUCCESS = 0x00,
    MPAF_STATUS_PENDING = 0x01,
    MPAF_STATUS_BUSY = 0x02,
    MPAF_STATUS_PASS_ON = 0x03,
    MPAF_STATUS_FAILED = 0x04,
    MPAF_STATUS_INVALID_PARAMETER = 0x05,
    MPAF_STATUS_SDP_DONE = 0x06,
    MPAF_STATUS_INTERNAL_FAILURE = 0x07,
    MPAF_STATUS_PAGE_TIMEOUT = 0x08,
    MPAF_STATUS_AUTH_FAILURE = 0x09,
    MPAF_STATUS_CONN_TIMEOUT = 0x0A,
    MPAF_STATUS_MEM_CAPACITY_EXCEEDED = 0x0B,
    MPAF_STATUS_COMMAND_DISALLOWED = 0x0C,
    MPAF_STATUS_UNKNOWN_COMMAND = 0x0D,
