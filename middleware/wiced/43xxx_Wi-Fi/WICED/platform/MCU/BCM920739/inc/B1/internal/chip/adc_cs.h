...
typedef enum ADC_INPUT_CHANNEL_SEL { 
    ADC_INPUT_P17           =   0x0,    //ADC MUX IN 16
    ADC_INPUT_P16           =   0x1,    //ADC MUX IN 17
    ADC_INPUT_P15           =   0x2,    //ADC MUX IN 18
    ADC_INPUT_P14           =   0x3,    //ADC MUX IN 19
    ADC_INPUT_P13           =   0x4,    //ADC MUX IN 20
    ADC_INPUT_P12           =   0x5,    //ADC MUX IN 21
    ADC_INPUT_P11           =   0x6,    //ADC MUX IN 22
    ADC_INPUT_P10           =   0x7,    //ADC MUX IN 23
    ADC_INPUT_P9            =   0x8,    //ADC MUX IN 24
    ADC_INPUT_P8            =   0x9,    //ADC MUX IN 25
    ADC_INPUT_P1            =   0xA,    //ADC MUX IN 26
    ADC_INPUT_P0            =   0xB,    //ADC MUX IN 27
    ...
    ADC_INPUT_P38           =   0x10,   //ADC MUX IN 0
    ADC_INPUT_P37           =   0x11,   //ADC MUX IN 1
    ADC_INPUT_P36           =   0x12,   //ADC MUX IN 2
    ADC_INPUT_P35           =   0x13,   //ADC MUX IN 3
    ADC_INPUT_P34           =   0x14,   //ADC MUX IN 4
    ADC_INPUT_P33           =   0x15,   //ADC MUX IN 5
    ADC_INPUT_P32           =   0x16,   //ADC MUX IN 6
    ADC_INPUT_P31           =   0x17,   //ADC MUX IN 7
    ADC_INPUT_P30           =   0x18,   //ADC MUX IN 8
    ADC_INPUT_P29           =   0x19,   //ADC MUX IN 9
    ADC_INPUT_P28           =   0x1A,   //ADC MUX IN 10
    ADC_INPUT_P23           =   0x1B,   //ADC MUX IN 11
    ADC_INPUT_P22           =   0x1C,   //ADC MUX IN 12
    ADC_INPUT_P21           =   0x1D,   //ADC MUX IN 13
    ADC_INPUT_P19           =   0x1E,   //ADC MUX IN 14
    ADC_INPUT_P18           =   0x1F,   //ADC MUX IN 15
