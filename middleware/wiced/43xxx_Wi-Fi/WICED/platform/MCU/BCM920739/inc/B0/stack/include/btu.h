...
enum
{
    BTU_VS_RESET_CONT_EVT = 1, BTU_VS_FEAT_INIT_EVT, BTU_VS_CFG_CODEC_EVT, BTU_VS_SET_WBS_CODEC_EVT, BTU_VS_CFG_SCO_PATH_EVT, BTU_VS_INT_TIMEOUT_EVT, BTU_VS_H4IBSS_EVT, BTU_VS_L2C_CTRL_ENC_EVT, BTU_VS_TBFC_CONN_EVT, BTU_VS_TBFC_RESET_EVT, BTU_VS_TBFC_SUSPEND_EVT, BTU_VS_TBFC_LE_NOTIFY_EVT, BTU_VS_READ_BPCS_EVT, BTU_VS_TBFC_TRIGGER_EVT, BTU_VS_LE_BURST_DATA_EVT, BTU_VS_SET_LOCAL_ADDR_EVT, BTU_VS_TOPOLOGY_CHECK_EVT, BTU_VS_MULTI_ADV_PRIVACY_EVT, BTU_VS_MULTI_ADV_REFRESH_RPA_EVT, BTU_VS_MULTI_ADV_REENABLE_EVT
};
